...
## Live Demo
- Click [here](https://geeky-t.github.io/frontend-portfolio-leaderboard-project/) for the live demo.
...
```
git clone https://github.com/geeky-T/frontend-portfolio-leaderboard-project.git
```
